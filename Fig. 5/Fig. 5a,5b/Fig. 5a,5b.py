...
"""
===============================================================================
Fig. 5a, 5b: Grand Average Ridge Plot Analysis (SCG Time-Frequency Distribution)
===============================================================================
[Analysis Method ]
    This script performs a high-resolution Time-Frequency Analysis of Seismocardiogram
    (SCG) signals to generate the Grand Average Ridge Plots (Joyplots) for Fig. 5a/5b.
...
if __name__ == "__main__":
    ...
    if all_atlases:
        ...
        pkl_filename = os.path.join(current_dir, "Fig. 5a,5b_plot_data.pkl")
        ...
        Fig_5, _ = plot_Fig_5_with_marginals(
            grand_average_atlas,
            apply_filter=True,
            bg_stats=bg_stats,
