...
"""
===============================================================================
Fig. 5a, 5b: Plot from Pickle Data
===============================================================================
This script loads the pre-computed Grand Average Atlas from `Fig. 5a,5b_plot_data.pkl`
...
if __name__ == "__main__":
    ...
    figures_to_generate = [
        {
            "pickle_file": "Fig. 5a_plot_data.pkl",
            "output_name": "Fig. 5a",
            "title": "HFpEF Population Atlas (n=56)",
        },
        {
            "pickle_file": "Fig. 5b_plot_data.pkl",
            "output_name": "Fig. 5b",
            "title": "HFrEF Population Atlas (HF, n=88)",
        },
    ]
    ...
    for fig_info in figures_to_generate:
        ...
        try:
            ...
            Fig_5 = plot_Fig_5_with_marginals(
                grand_average_atlas,
                title_prefix=title,
                apply_filter=True,
                bg_stats=bg_stats,
